#########################################Plot1.R SCRIPT######################################
## THIS SCRIPTS PLOTS AND CREATES plot1.png  file. IN THIS SCRIPTS TWO(2) FUNCTIONS ARE    ##
## DEFINED AND USED:                                                                       ##
...
######################################### GERERATE PLOT######################################
## CALL generatePlot() FUNCTION (define above) TO GENERATE PLOT and save in file plot1.png ##
#############################################################################################
